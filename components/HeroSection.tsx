...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-background via-secondary/30 to-background py-8 sm:py-12 md:py-16 bg-hatching">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:heading-hero text-foreground mb-6 text-balance max-w-2xl mx-auto" style={{ fontFamily: "var(--font-staatliches), 'Staatliches', sans-serif", textTransform: 'uppercase', letterSpacing: '0.04em', minHeight: "2.2em" }}>
            575
